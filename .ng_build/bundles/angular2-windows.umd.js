(function (global, factory) {
	...
	(factory((global['angular2-windows'] = {}),global.ng.core,global.ng.platformBrowser,global.ng.animations));
}(this, (function (exports,core,platformBrowser,animations) { 'use strict';
...
WindowComponent.decorators = [
    { type: core.Component, args: [{
                ...
                animations: [
                    animations.trigger("WindowState", [
                        ...
                        animations.transition('up <=> active', animations.animate('620ms cubic-bezier(0.455, 0.03, 0.515, 0.955)')),
                        animations.transition('down <=> active', animations.animate('620ms cubic-bezier(0.455, 0.03, 0.515, 0.955)'))
                    ])
                ]
            },] },
];
...
var WBackgroundComponent = /** @class */ (function () {
    function WBackgroundComponent() {
    }
    return WBackgroundComponent;
}());
 ...
 * @nocollapse
 */
WBackgroundComponent.ctorParameters = function () { return []; };
...
var BoundCallbackObservable = (function (_super) {
    ...
    BoundCallbackObservable.dispatch = function (state$$1) {
        var self = this;
        var source = state$$1.source, subscriber = state$$1.subscriber, context = state$$1.context;
...
var GenerateObservable = (function (_super) {
    ...
    GenerateObservable.prototype._subscribe = function (subscriber) {
        ...
        do {
            if (condition) {
                ...
                try {
                    conditionResult = condition(state$$1);
                }
                catch (err) {
                    subscriber.error(err);
                    return;
    ...
    GenerateObservable.dispatch = function (state$$1) {
        var subscriber = state$$1.subscriber, condition = state$$1.condition;
        if (subscriber.closed) {
            return;
        }
        if (state$$1.needIterate) {
            try {
                state$$1.state = state$$1.iterate(state$$1.state);
            }
            catch (err) {
                subscriber.error(err);
                return;
            ...
            state$$1.needIterate = true;
        }
        if (condition) {
            var conditionResult = void 0;
            try {
                conditionResult = condition(state$$1.state);
            }
            catch (err) {
                subscriber.error(err);
                return;
        ...
        var value;
        try {
            value = state$$1.resultSelector(state$$1.state);
        }
        catch (err) {
            subscriber.error(err);
            return;
...
var IntervalObservable = (function (_super) {
    ...
    IntervalObservable.dispatch = function (state$$1) {
        var index = state$$1.index, subscriber = state$$1.subscriber, period = state$$1.period;
...
"use strict";
var race_2 = race_1.raceStatic;
var race$2 = {
    race: race_2
};
"use strict";
Observable_1.Observable.race = race$2.race;
"use strict";
...
function dispatch$1(state$$1) {
    var obj = state$$1.obj, keys = state$$1.keys, length = state$$1.length, index = state$$1.index, subscriber = state$$1.subscriber;
    if (index === length) {
        subscriber.complete();
        return;
    }
...
var RangeObservable = (function (_super) {
    ...
    RangeObservable.dispatch = function (state$$1) {
        var start = state$$1.start, index = state$$1.index, count = state$$1.count, subscriber = state$$1.subscriber;
        if (index >= count) {
            subscriber.complete();
            return;
        }
...
var VirtualAction = (function (_super) {
    ...
    VirtualAction.prototype.schedule = function (state$$1, delay) {
        if (delay === void 0) {
            delay = 0;
        }
        if (!this.id) {
        ...
        this.add(action);
        return action.schedule(state$$1, delay);
    };
    ...
    VirtualAction.prototype._execute = function (state$$1, delay) {
        if (this.active === true) {
            return _super.prototype._execute.call(this, state$$1, delay);
        }
    };
...
var WindowsComponent = /** @class */ (function () {
    ...
    WindowsComponent.prototype.ngAfterContentInit = function () {
        ...
        this._scrollObserver.subscribe(function (e) {
            ...
            var /** @type {?} */ delta = Math.max(-1, Math.min(1, (e.deltaY || -e.detail)));
            if (delta < 0) {
                //scrolled up
                _this.previousWindow();
            }
 ...
 * @nocollapse
 */
WindowsComponent.ctorParameters = function () { return [
    { type: core.Renderer, },
    { type: core.ElementRef, },
]; };
WindowsComponent.propDecorators = {
    'windows': [{ type: core.ContentChildren, args: [WindowComponent,] },],
};
 ...
 * @nocollapse
 */
WindowsModule.ctorParameters = function () { return []; };

exports.WindowsModule = WindowsModule;
exports.ɵc = WBackgroundComponent;
exports.ɵb = WindowComponent;
exports.ɵa = WindowsComponent;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=angular2-windows.umd.js.map
